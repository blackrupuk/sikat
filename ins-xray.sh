...
sleep 1 
wget -q -O /etc/xray/config.json "https://raw.githubusercontent.com/blackrupuk/sikat/main/conf/config.json"
chmod +x /etc/xray/config.json
sleep 1 
rm -f /etc/nginx/conf.d/xray.conf
wget -q -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/blackrupuk/sikat/main/conf/xray.conf"
