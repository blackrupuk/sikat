...
Name=$(curl -sS https://raw.githubusercontent.com/blackrupuk/sikat/main/permission/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/blackrupuk/sikat/main/permission/ip | grep $MYIP | awk '{print $1}')
